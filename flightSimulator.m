...
% College       : Ursa Major Ascending Forward
% Year          : 2015-16
% Author        : Oliver Salmeron
%
% Goal          : Collaborate post processing algorithms amongst teams to share,
% improve and optimtize code. Read the License.txt for more info on the
% idea.
%
% Description   : Matlab script for processing IMU data to simulate the flight motion and path. 
% 
...
for Time = 1:7000     % Update limits of while loop to the desired Time frame
    ...
    % New Plot
    drawnow;
    pause(0.0001);            % Change the plot rate of MATLAB animation (not video)
